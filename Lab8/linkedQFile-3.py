...
class LinkedQ:
  ...
  def peek(self):
    """
    Method lets the system peek of what character comes next in the linked queue.
    :return: The value of the next character or None if empty.
    """
    if self._first != None:
      if self._first.next != None:
        return self._first.next.value
    else:
      return None
